// JSLint directives
/*property
    abbr, backName, bookById, books, citeAbbr, citeFull, forEach, fullName,
    gridName, id, jstTitle, maxBookId, minBookId, nextChapter, numChapters,
    parentBookId, prevChapter, push, slice, subdiv, tocName,
...
var Scriptures = (function () {
    ...
    var encodedScriptureUrlParameters = function (bookId, chapter, verses, isJst) {
        ...
        if (bookId !== undefined && chapter !== undefined) {
            ...
            return 'http://scriptures.byu.edu/scriptures/scriptures_ajax/' +
                    bookId + '/' + chapter + '?verses=' + options;
        }
    };
